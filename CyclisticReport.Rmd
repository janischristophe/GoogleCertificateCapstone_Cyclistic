...
+==================================+==================================+
| Define and Discuss the Project   | -   Create scope of work         |
|                                  |     documentation                |
...
|                                  |     and expectations             |
+----------------------------------+----------------------------------+
| Prepare the Data for Exploration | -   Identify source of data,     |
|                                  |     collect, and store           |
|                                  | -   Determine data reliability,  |
|                                  |     origin, comprehensiveness,   |
|                                  |     current relevance,           |
|                                  |     credibility, and licensing   |
|                                  | -   Identify data organization;  |
|                                  |     sort and filter              |
+----------------------------------+----------------------------------+
| Process the Data for Analysis    | -   Determine the tools that     |
...
|                                  |     data types                   |
|                                  | -   Ensure that data being used  |
|                                  |     is clean                     |
|                                  | -   Document the cleaning        |
|                                  |     process                      |
+----------------------------------+----------------------------------+
| Conduct a Descriptive Analysis   | -   Organize, and format data    |
|                                  |     properly                     |
|                                  | -   Identify trends in the data  |
|                                  |     with calculations, data      |
|                                  |     aggregation, and             |
|                                  |     visualization                |
|                                  | -   Provide a detailed           |
...
|                                  |     representative data          |
+----------------------------------+----------------------------------+
| Share Findings with Stakeholders | -   What story is the analysis   |
|                                  |     telling and how does it      |
...
|                                  |     accessible presentation that |
|                                  |     helps solve the business     |
|                                  |     problem discussed beforehand |
+----------------------------------+----------------------------------+
| Act on Key Findings              | -   Explore how additional data  |
|                                  |     parameters would expand upon |
|                                  |     the analysis and insights    |
|                                  | -   Share recommendations based  |
|                                  |     on analytical findings, with |
|                                  |     shareholders to to help the  |
|                                  |     marketing team in their      |
|                                  |     project.                     |
+----------------------------------+----------------------------------+
